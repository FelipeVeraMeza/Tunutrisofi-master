...
import { User, Calendar, Clock, Mail, Phone, CheckCircle2, CreditCard } from 'lucide-react';

const Step6_Confirmation = ({ selectedType, selectedDate, selectedTime, formData }) => {
  return (
    <motion.div
    ...
    >
      ...
      <div className="mt-6 bg-blue-50 p-4 rounded-xl border border-blue-100 flex items-start gap-3">
        ...
        <p className="text-sm text-blue-800">
          Al confirmar, serás redirigido a la página para subir tu comprobante de pago. Tu reserva quedará en estado "Pendiente de Pago" hasta que lo subas.
        </p>
      </div>
    </motion.div>
  );
